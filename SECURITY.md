...
`ghost` is published to npm (`opencode-ghost`) and developed on `main`. Only the
...
opencode-ghost` or a fresh `git pull`) before reporting an issue.
...
[security]: https://github.com/ozandogrultan/opencode-ghost/security
